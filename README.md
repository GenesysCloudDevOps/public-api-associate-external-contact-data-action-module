A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Associate External Contact
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-associate-external-contact-data-action-module.git?ref=v1.0.0"
    action_name        = "Associate External Contact"
